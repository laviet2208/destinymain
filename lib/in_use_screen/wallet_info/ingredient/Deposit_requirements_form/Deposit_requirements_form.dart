...
class Deposit_requirements_form extends StatefulWidget {
  const Deposit_requirements_form({super.key});

  @override
  State<Deposit_requirements_form> createState() => _Deposit_requirements_formState();
}

class _Deposit_requirements_formState extends State<Deposit_requirements_form> {
  bool loading = false;
