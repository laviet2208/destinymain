              ...
              onTap: () {
                if (finalData.cartListSale.length == 0) {
                  ...
                  showModalBottomSheet(
                    ...
                    builder: (context) {
                      return in_flash_voucher_select(voucher: widget.voucher, ontap: () {
                        setState(() {

                        });
                      }, cost: calculatetotalSaleMoney());
                    },
                  );
                }
              },
            ...
            SizedBox(
              ...
              child: Padding(
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    if (finalData.cartListSale.isNotEmpty) {
                      ...
                      order.productList = finalData.cartListSale;
