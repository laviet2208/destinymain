...
class edit_text_in_account extends StatelessWidget {
  ...
  final String hint;
  final bool readOnly;
  const edit_text_in_account({super.key, required this.textEditingController, required this.event, required this.title, required this.hint, required this.readOnly});
